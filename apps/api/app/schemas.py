...
class UserCreate(BaseModel):
    ...
    role: str = Field(
        pattern="^(administrator|operations_manager|security_staff|medical_team|volunteer|transportation_team|fan)$"
    )
...
class KnowledgeDocumentCreate(BaseModel):
    ...
    category: str = Field(
        pattern="^(crowd|security|medical|transport|accessibility|sustainability|general)$"
    )
